...
$returnString = '<img title="naruto,browsergame" alt="naruto,browsergame" src="img.php?url='.htmlspecialchars($content).'"';
$serverUrl = 'v2.n-bg.de';
$urlLength = strlen($serverUrl);
if(substr($content,0,$urlLength) == $serverUrl)
{
  $returnString = '<img title="naruto,browsergame" alt="naruto,browsergame" src="'.htmlspecialchars($content).'"';
}
